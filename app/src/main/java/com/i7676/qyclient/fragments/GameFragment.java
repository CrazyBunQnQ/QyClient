...
public class GameFragment extends BaseFragment<GamePresenter, GameView> implements GameView {
    ...
    @Override
    public void renderGameCards(final List<GameEntity> gameEntities) {
    ...
    private class GameCardAdapter extends BaseQuickAdapter<GameCardEntity> {
        ...
        @Override
        protected void convert(BaseViewHolder baseViewHolder, GameCardEntity gameCardEntity) {
