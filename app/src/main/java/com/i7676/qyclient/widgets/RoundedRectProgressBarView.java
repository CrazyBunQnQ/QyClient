...
/**
 * Created by 韩吉 on 2016/9/8.
 *
 * 自定义的礼包领取进度条
 */
public class RoundedRectProgressBarView extends View {
    ...
    public RoundedRectProgressBarView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public RoundedRectProgressBarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundedRectProgressBarView(Context context) {
        this(context, null);
    }
